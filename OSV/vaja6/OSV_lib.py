...
# primeri za 2. kolokvij

# slika in matrika preslikave --> kaj to naredi sliki (veš da recimo se nekja zarotira)
# brez kalk.
# afine preslikave (3x3 matrike - kaj pomenijo kere cifre)
# kaj naredijo radialne preslikave 
# kaj so thresholdi, windowing itd. - znas povedat kaj to naredi na sliki